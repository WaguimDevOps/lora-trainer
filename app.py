...
# Placeholder da função de treinamento
def start_training(model_base, resolution, batch_size, learning_rate, epochs,
    ...
    if not max_train_steps:
        max_train_steps = calculate_steps(image_count, int(repeats), int(epochs), int(batch_size))

    return f"Treinamento iniciado com {max_train_steps} steps calculados automaticamente."
